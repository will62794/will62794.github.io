...
We can automatically check correctness of TLA+ specifications using [TLC](https://github.com/tlaplus/tlaplus), a model checker that will exhaustively explore a spec's reachable states to check that a specified property (i.e. an invariant) holds.
