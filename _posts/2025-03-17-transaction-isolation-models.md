...
Transaction isolation is a dense topic with a lot of history. There have been many attempts over the years to formalize the [zoo of various isolation and consistency concepts](https://jepsen.io/consistency), though [it is not always clear](https://dl.acm.org/doi/pdf/10.1145/3035918.3056096) to what extent these attempts have clarified things for consumers of these systems, especially when introducing new layers of complexity and notation. The rise of distributed storage systems and the need to reason about isolation in these contexts has likely worsened the problem over the past decade or so.

<!-- If we want to say anything precise about transaction isolation, we do need some formal model in which to reason about it.  -->
There are a host of different formalisms that all approach the problem from different angles, with different notations, frameworks, etc. ([Adya](https://pmg.csail.mit.edu/papers/adya-phd.pdf), [Cerone](https://drops.dagstuhl.de/storage/00lipics/lipics-vol042-concur2015/LIPIcs.CONCUR.2015.58/LIPIcs.CONCUR.2015.58.pdf), [Crooks](https://dl.acm.org/doi/10.1145/3087801.3087802)). It is helpful, though, to try to understand some common underyling concepts between them. In particular there are two modern, "read-centric" formalisms of isolation, [Cerone 2015](https://drops.dagstuhl.de/storage/00lipics/lipics-vol042-concur2015/LIPIcs.CONCUR.2015.58/LIPIcs.CONCUR.2015.58.pdf) and [Crooks 2017](https://dl.acm.org/doi/10.1145/3087801.3087802), which are both notably distant from the foundational work of [Adya 1999](https://pmg.csail.mit.edu/papers/adya-phd.pdf) and bear similarities in their core ideas.
