...
Transactions are a core feature of databases, but absent from most mainstream programming languages.
...
There are a wide variety of techniques that have been applied in practice, which can be understood by looking both at the underlying programming models and the dominant transactional systems that introduced them.
